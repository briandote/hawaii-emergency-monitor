...
export const BOOTSTRAP_CACHE_KEYS: Record<string, string> = {
  ...
  emergencyAlerts:     'emergency:hawaii-alerts:v1',
  emergencyStreamGauges: 'emergency:stream-gauges:v1',
  emergencyShelters:   'emergency:shelters:v1',
  emergencyRoadClosures: 'emergency:road-closures:v1',
  emergencyPowerOutages: 'emergency:power-outages:v1',
  emergencyTideGauges: 'emergency:tides:v1',
};
...
export const BOOTSTRAP_TIERS: Record<string, 'slow' | 'fast'> = {
  ...
  emergencyAlerts: 'fast',
  emergencyStreamGauges: 'fast',
  emergencyShelters: 'slow',
  emergencyRoadClosures: 'fast',
  emergencyPowerOutages: 'fast',
  emergencyTideGauges: 'fast',
};
