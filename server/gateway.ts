...
const RPC_CACHE_TIER: Record<string, CacheTier> = {
  ...
  '/api/emergency/v1/list-active-alerts': 'fast',
  '/api/emergency/v1/list-stream-gauges': 'fast',
  '/api/emergency/v1/list-shelters': 'slow',
  '/api/emergency/v1/list-road-closures': 'fast',
  '/api/emergency/v1/list-power-outages': 'fast',
  '/api/emergency/v1/list-tide-gauges': 'fast',
};
