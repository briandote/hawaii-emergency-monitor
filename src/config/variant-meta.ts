...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  ...
  emergency: {
    title: 'Hawaii Emergency Monitor',
    description: 'Real-time Hawaii emergency response dashboard with weather alerts, evacuation notices, shelter locations, road closures, and power outage tracking.',
    keywords: 'hawaii emergency, disaster response, weather alerts, evacuation, shelter locations, road closures, power outages, stream gauges, flood zones, emergency management, NWS alerts, HI-EMA',
    url: 'https://emergency.worldmonitor.app/',
    siteName: 'Hawaii Emergency Monitor',
    shortName: 'HI Emergency',
    subject: 'Hawaii Emergency Response and Disaster Awareness',
    classification: 'Emergency Dashboard, Disaster Response, Weather Alerts',
