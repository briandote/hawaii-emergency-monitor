...
export type MapVariant = 'full' | 'tech' | 'finance' | 'happy' | 'commodity' | 'emergency';
...
export const LAYER_REGISTRY: Record<keyof MapLayers, LayerDefinition> = {
  ...
  shelters:                 def('shelters',                 '&#127968;', 'shelters',                 'Shelters'),
  roadClosures:             def('roadClosures',             '&#128679;', 'roadClosures',             'Road Closures', ['flat']),
  streamGauges:             def('streamGauges',             '&#127754;', 'streamGauges',             'Stream Gauges', ['flat']),
  powerOutages:             def('powerOutages',             '&#9889;',   'powerOutages',             'Power Outages', ['flat']),
  evacuationZones:          def('evacuationZones',          '&#128680;', 'evacuationZones',          'Evacuation Zones', ['flat']),
  floodZones:               def('floodZones',               '&#128167;', 'floodZones',               'Flood Zones', ['flat']),
};
...
const VARIANT_LAYER_ORDER: Record<MapVariant, Array<keyof MapLayers>> = {
  ...
  emergency: [
    'shelters', 'roadClosures', 'streamGauges', 'powerOutages',
    'evacuationZones', 'floodZones', 'weatherRadar',
    'weather', 'natural', 'fires', 'climate',
  ],
};
...
export const LAYER_SYNONYMS: Record<string, Array<keyof MapLayers>> = {
  ...
  flood: ['floodZones', 'weather', 'natural'],
  wildfire: ['fires'],
  forest: ['fires'],
  ...
  livecam: ['webcams'],
  shelter: ['shelters'],
  evacuation: ['evacuationZones'],
  road: ['roadClosures'],
  closure: ['roadClosures'],
  gauge: ['streamGauges'],
  stream: ['streamGauges'],
  power: ['powerOutages'],
  outage: ['powerOutages', 'outages'],
};
